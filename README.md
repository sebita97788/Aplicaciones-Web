...
| **Users and customers** <br> **What types of users and customers should you focus on first?** | **User benefits** <br> **What are the goals your users are trying to achieve? What is motivating them to seek out your solution?** | **Hypotheses** <br> **Combine the assumptions into the following template hypothesis statement: "We believe that [business outcome] will be achieved if [user] attains [benefit] with [feature]". Each hypothesis should focus on one feature.** |
